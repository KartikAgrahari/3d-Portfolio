  ...
  const handleSubmit =(e) => {
    ...
    emailjs.send(
      ...
      'template_412t1pv',
      {
        ...
        to_email : 'ravijiteja00@gmail.com',
      ...
      <motion.div
       ...
       className="flex-[0.75] bg-black-100 p-8 rounded-2xl">
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
          ...
          <button type="submit" className="bg-tertiary py-3 px-8 outline-none text-white shadow-md shadow-primary rounded-xl w-fit font-bold">{loading ? 'Sending...' : 'Send' }</button>
        </form>
      </motion.div>
